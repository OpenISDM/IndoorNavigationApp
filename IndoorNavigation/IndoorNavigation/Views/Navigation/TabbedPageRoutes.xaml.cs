...
namespace IndoorNavigation.Views.Navigation
{
    public partial class TabbedPageRoutes : ContentPage
    {
        ...
        void RoutesListView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            // disable it
        ...
        //        new RoutesDataClass{ Order=1, OpacityValue=0.3, ImageSrc="Arrow_up.png", Instruction="往前方路口直走", Floor="3樓" },
        //        new RoutesDataClass{ Order=2, OpacityValue=1, ImageSrc="Arrow_left.png", Instruction="向左轉", Floor="1樓" },
        //        new RoutesDataClass{ Order=3, OpacityValue=0.3, ImageSrc="Arrow_up.png", Instruction="請直走", Floor="3樓" },
        ...
        //        new RoutesDataClass{ Order=7, OpacityValue=0.3, ImageSrc="Arrow_right.png", Instruction="向右轉", Floor="1樓" },
        //        new RoutesDataClass{ Order=8, OpacityValue=0.3, ImageSrc="Arrow_up.png", Instruction="請直走", Floor="1樓" }
        //    };
